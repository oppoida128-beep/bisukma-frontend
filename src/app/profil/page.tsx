      ...
      <section className="container mx-auto px-4 -mt-12">
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-16 space-y-16">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="border-none bg-accent/5 p-8">
            ...
            <Card className="border-none bg-primary/5 p-8">
              <CardContent className="p-0 space-y-4">
          ...
          <div className="space-y-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={i} className="text-center space-y-3 p-6 rounded-xl hover:bg-muted transition-colors">
